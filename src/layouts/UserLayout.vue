...
<template>
    <div class="max-w-screen-xl mx-auto">
      <div class="navbar bg-base-100">
        <div class="flex-1">
          <RouterLink to="/" class="btn btn-ghost normal-case text-xl">PHONPADID SHOP</RouterLink>
        </div>
        <div class="flex-none">
          ...
          <div class="dropdown dropdown-end">
            ...
            <div tabindex="0" class="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
              <div class="card-body">
                ...
                <span class="text-info">Subtotal: {{ userCartStore.summaryPrice }}KIP</span>
          ...
          <div v-else class="dropdown dropdown-end">
            <label tabindex="0" class="btn btn-ghost btn-circle avatar">
              <div class="w-10 rounded-full">
                <img src="https://lh3.googleusercontent.com/ogw/ANLem4b8z2JwgkrrkDZD_QPQYcVSEpjdCnQnskoQ-s14OQ=s32-c-mo"/>
              </div>
            </label>
