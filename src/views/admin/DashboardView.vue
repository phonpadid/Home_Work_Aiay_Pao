...
const barOption: { options:any; series:any } = {
  options: {
    chart: {
      id: 'vuechart-example',
    },
...
const donutOption: { options: any; series: number[] } = {
  options: {},
